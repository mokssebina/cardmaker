...
const PreviewHeader = ({ day, setDay, cardTitle, headerLight, headerDark, lightColor, darkColor, font }) => {
    return (
        <div style={{backgroundColor: `${day ? headerLight : headerDark}`}} className={`absolute w-2/5 ml-[30%] h-14 z-10 top-4 flex flex-row ${day ? `border-[#283038]` : `border-[#cee5f0]`} border py-2 rounded-lg`}>
